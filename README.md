...
Create a `.env` and ask for the configuration files.
...
Open your browser and navigate to `http://localhost:5000/` to verify that the application is running correctly, and also you can access the app via API documentation `http://localhost:5000/api/docs`
